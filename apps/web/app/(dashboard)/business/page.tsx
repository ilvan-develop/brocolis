  ...
  return (
    <main className="flex min-h-screen flex-col gap-6 p-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle>{tF4("procurement.approval.title")}</CardTitle>
            <CardDescription>
              {tF4("procurement.approval.pending")}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground text-sm">0</p>
        ...
        <Card>
          <CardHeader>
            <CardTitle>{tF4("procurement.credit.title")}</CardTitle>
            <CardDescription>
              {tF4("procurement.credit.available")}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground text-sm">0</p>
