...
const _STATUS_LABEL: Record<string, F4MessageKey> = {
  DRAFT: "procurement.status.DRAFT",
  OPEN: "procurement.status.OPEN",
  QUOTED: "procurement.status.QUOTED",
  AWARDED: "procurement.status.AWARDED",
  CANCELED: "procurement.status.CANCELED",
  EXPIRED: "procurement.status.EXPIRED",
};
